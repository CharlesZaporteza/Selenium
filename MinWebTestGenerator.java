...
public class MinWebTestGenerator {
    ...
    String testsuite() {
        ...
        // Do i need to change the file locations when I turn it in
        // Do a test the cases where there is no click wven though there is no assertEquals? If so "notclick" isnt a method
        	...
        	for(int y = 0; y<4; y +=1){
        		...
        		for(int z = 0; z<4; z +=1){
        			...
        			for(int ck = 0; ck < 2; ck += 1){ // 0 = clicked, 1 = not clicked
            	        ...
            	        sb.append("   wd.get(\"file:///C:/Users/Charles/workspace/EE360T/src/pset6/min.html\");\n");
